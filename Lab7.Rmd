...
## Exercise 1 - Install Bioconductor and the above packages.
...
## Exercise 2 - Read through the html version of the vignette.

## Exercise 3 - Line by line run the R script to make sure the vignette runs properly on your computer and so that you can see the steps involved. Note that vignette uses tidyverse packages ggplot2 and dyplr, but also makes use of core R plotting packages.
