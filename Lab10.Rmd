...
```{r}
write.vcf(vcf, "data/myVCFdata_filtered.vcf")
```
...
A Qscore higher than 20 or 30 is considered good quality data.  
...
3. Can you figure out how to zoom in on a particular region of a chromosome in chromoqc()? The x-axis is given a range to zoom in on area with DP.
