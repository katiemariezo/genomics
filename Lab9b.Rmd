...
An example: “Your character is unconscious. Roll a d20 so see if they wake up or not. Roll a ten or higher to make the save."
...
The next thing we can do is create a function that actually has a non-trivial function body. Aka it does something.
...
Alternatively, we can specify the argument “num” from the function specifically.
